...
|------|------|
| 轮次 | Round 7 |
| 训练步数 | **1,200,000** / 10,000,000 (约 12.0%) |
| 起始时间 | 2026-06-12 16:19:55 |
| 结束时间 | ⏳ 进行中（120万步评估） |
| 状态 | 🚀 **训练中，突破历史最高 +2056.50，步态接近人类** |
| RESUME_FROM | `./models/round_7/sac_bipedalwalker_final.zip`（45万步检查点，速度挂钩） |
| 奖励塑形 | ✅ 启用 (速度挂钩版) |
| 超参数变更 | 见下方 |
| 训练耗时 | ⏳ 进行中 |
| 平均 FPS | ~85 |
...
| 400,000 | +974.32 | 726.77 | 762 | 复杂地形暴露弱点，std 大 |
| 450,000 | +1397.66 | **185.56** | 1143 | ✅ std 大幅收窄，策略一致 |
| 500,000 | ~ | ~ | ~ | 用户中断，切换到速度挂钩奖励 |
| **1,200,000** | **+2056.50** | **21.33** | 1108 | 🎉 **里程碑！突破 +2000，步态接近人类** |
...
4. **用户观察："已经很接近人类了，虽然看起来还有些机械"**：速度挂钩奖励成功消除了独脚蹭行，模型学会了接近人类的步态
...
| 7 | Round 6 10万步 + 条件化塑形 | 1,200,000 | **+2056.50** | **+2056.50** | ⏳ | 🎉 **里程碑突破！条件化塑形 + 速度挂钩 = 步态接近人类，突破 +2000** |
